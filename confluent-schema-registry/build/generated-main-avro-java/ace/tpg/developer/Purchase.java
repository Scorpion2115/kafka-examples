...
public class Purchase extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 6778533762217973038L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Purchase\",\"namespace\":\"ace.tpg.developer\",\"fields\":[{\"name\":\"id\",\"type\":\"int\"},{\"name\":\"product\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"quantity\",\"type\":\"int\"}],\"compatibility\":\"BACKWARD\"}");
   ...
   */
  public static ace.tpg.developer.Purchase.Builder newBuilder() {
    return new ace.tpg.developer.Purchase.Builder();
  }
   ...
   * @return A new Purchase RecordBuilder
   */
  public static ace.tpg.developer.Purchase.Builder newBuilder(ace.tpg.developer.Purchase.Builder other) {
    return new ace.tpg.developer.Purchase.Builder(other);
  }
   ...
   * @return A new Purchase RecordBuilder
   */
  public static ace.tpg.developer.Purchase.Builder newBuilder(ace.tpg.developer.Purchase other) {
    return new ace.tpg.developer.Purchase.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Purchase>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(ace.tpg.developer.Purchase.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(ace.tpg.developer.Purchase other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder setId(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder clearId() {
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder setProduct(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder clearProduct() {
      product = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public ace.tpg.developer.Purchase.Builder clearQuantity() {
